...
export interface ISessionInfoManager {
     ...
     */
    set(sessionId: string, sessionInfo: Partial<ISessionInfo & ISessionInternalInfo>): Promise<void>;
    /**
     ...
     */
    setOidcContext(sessionId: string, authorizationRequestState: AuthorizationRequestState): Promise<void>;
}
