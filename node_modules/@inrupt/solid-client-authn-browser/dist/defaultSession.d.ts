 ...
 * @since 1.3.0
 */
export declare function fetch(...args: Parameters<Session["fetch"]>): ReturnType<Session["fetch"]>;
/**
 ...
 * @since 1.3.0
 */
export declare function login(...args: Parameters<Session["login"]>): ReturnType<Session["login"]>;
/**
 ...
 * @since 1.3.0
 */
export declare function logout(...args: Parameters<Session["logout"]>): ReturnType<Session["logout"]>;
/**
 ...
 * @since 1.3.0
 */
export declare function handleIncomingRedirect(...args: Parameters<Session["handleIncomingRedirect"]>): ReturnType<Session["handleIncomingRedirect"]>;
/**
 * {@link SessionEventEmitter} instance to subscribe to events by the default session.
 *
 * @since 1.14.0
 */
export declare function events(): Session["events"];
