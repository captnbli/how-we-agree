...
export declare class ParsingContext {
    ...
    readonly rdfDirection?: 'i18n-datatype' | 'compound-literal' | 'disabled';
     ...
     */
    parseContext(context: JsonLdContext, parentContext?: IJsonLdContextNormalizedRaw, ignoreProtection?: boolean, allowDirectlyNestedContext?: boolean): Promise<JsonLdContextNormalized>;
    /**
